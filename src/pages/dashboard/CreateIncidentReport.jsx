      ...
      <form onSubmit={handleSubmit} className="space-y-8 pb-20">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              <div className="font-bold text-base">Campus Safety (Generic)</div>
              <div className="text-xs text-gray-500 mt-1">Generic reporting structure for campus/general security logs.</div>
            </button>
