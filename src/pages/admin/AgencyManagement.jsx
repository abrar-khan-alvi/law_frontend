                      ...
                      <td className="px-6 py-4">
                        <div className="flex flex-col gap-1 text-xs">
                          <span className={agency.requires_supervisor_review ? 'text-emerald-600 font-medium' : 'text-gray-400'}>
                            Supervisor {agency.requires_supervisor_review ? 'required' : 'skipped'}
                          </span>
                          <span className={agency.requires_prosecutor_review ? 'text-emerald-600 font-medium' : 'text-gray-400'}>
                            Prosecutor {agency.requires_prosecutor_review ? 'required' : 'skipped'}
                          </span>
                        </div>
                      </td>
                ...
                <div className="pt-6 border-t border-gray-100">
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center space-x-3 cursor-pointer">
                      ...
                      <span className="text-gray-700 font-medium">Require supervisor approval before export</span>
                    </label>
                    <label className="flex items-center space-x-3 cursor-pointer">
                      ...
                      <span className="text-gray-700 font-medium">Require prosecutor review after supervisor approval</span>
                    </label>
                  </div>
                </div>
